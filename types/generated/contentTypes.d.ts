...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    IntroBody: Attribute.RichText;
    TitleAnswer: Attribute.RichText;
    AnswerImg: Attribute.Media;
    Answer2Img: Attribute.Media;
    GodOnly: Attribute.Text;
    aShortQuote: Attribute.Text;
    sermonApp: Attribute.Media;
    SermonAppTitle: Attribute.String;
    appDescription: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
